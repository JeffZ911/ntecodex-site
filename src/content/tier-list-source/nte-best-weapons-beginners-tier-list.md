...
Patch 1.01 introduced buffs to "Youthful Fantasy" to compensate for changes in Chaos-attribute reactions. Additionally, the new character [Hotori](/characters/hotori-best-team-nte) has been released, showing high synergy with the "Umbrella Katana" undisclosed. Early testers suggest that while the standard Umbrella Arc is B-tier, the specific Katana variant may rank much higher once more data is available.
