...
qa_score: 5.5
word_count: 2156
published_at: "2026-05-24T20:55:45.251463+00:00"
...
![Methodology](/img/best-nte-dps-tier-list/inline-1.webp)
...
3.  **Tag-Team Utility:** The value a character provides when they are not the active "on-field" unit. Off-field damage and "Entry Bursts" are highly weighted.
4.  **Arc Type Compatibility:** How a character’s kit interacts with their assigned Arc (Solid, Liquid, Gas, or Plasma). For example, Plasma Arcs significantly boost follow-up attack frequency, which is central to the current S-tier meta.
5.  **Investment Floor vs. Ceiling:** We look at how a character performs at base level (Zero Awakening) compared to their maximum potential at high investment.
...
The "Cycle Rate" is the hidden stat that separates S-Tier units from the rest. A character with a high Cycle Rate can fill the party's shared Esper Meter in under 6 seconds of field time. This allows for rapid-fire switching, which is essential because many top-tier buffs (like [Sakiri](/characters/sakiri-nte-free-5-star-guide)’s Ultimate) only trigger upon a character exiting the field. Units that "hog" field time without providing equivalent burst damage often find themselves lower on the list.
...
While limited-time banners like "The Ichi-daime" ([Nanally](/characters/nanally-guide-nte)) offer the highest power ceiling, NTE provides robust free-to-play (F2P) options. Chiz, obtainable through the City Tycoon progression system, remains a competitive alternative to limited S-Tier units, proving that smart team building can often outweigh raw spending.

## S Tier

![S Tier](/img/best-nte-dps-tier-list/inline-2.webp)
...
![A Tier](/img/best-nte-dps-tier-list/inline-3.webp)
...
![B Tier](/img/best-nte-dps-tier-list/inline-4.webp)
...
![C Tier](/img/best-nte-dps-tier-list/inline-5.webp)
...
![Recent Changes](/img/best-nte-dps-tier-list/inline-6.webp)
