...
qa_score: 4.7
word_count: 1735
published_at: "2026-05-14T16:20:24.663791+00:00"
...
# Neverness to Everness (NTE) Reroll Tier List: Best Characters to Target
...
1.  **Account Creation**: Log in using a guest account or a salted email address.
2.  **Prologue Completion**: Follow the main story quest through the "Bridge Crossings" sequence. This involves basic combat tutorials and the first encounter with an Anomaly.
3.  **Unlock Scarborough Fair**: Once you reach the Hethereau Central Station, the "Scarborough Fair" gacha menu becomes accessible.
4.  **Claim Rewards**: Collect all pre-registration rewards, launch gifts, and "Hourglass Perks" from the mail system.
5.  **Spend Pulls**: Use your limited pulls on the "Misty Tipsy Style" banner ([Hotori](/characters/hotori-best-team-nte)) and your standard pulls on the "Strange Encounters" banner.
6.  **Reset**: If you do not pull an S-Rank character, log out, clear cache, and repeat the process.
...
Ideally, you should stop rerolling if you land one S-Rank character from the "S Tier" list within your first 20-30 pulls. If you manage to pull [Nanally](/characters/nanally-guide-nte) from a stray standard pull or Hotori from the limited banner, your account is considered "God Tier" for the current May 2026 meta.
...
![S Tier](/img/nte-reroll-tier-list/inline-2.webp)
...
![A Tier](/img/nte-reroll-tier-list/inline-3.webp)
...
![B Tier](/img/nte-reroll-tier-list/inline-4.webp)
...
![C Tier](/img/nte-reroll-tier-list/inline-5.webp)
...
![Recent Changes](/img/nte-reroll-tier-list/inline-6.webp)
