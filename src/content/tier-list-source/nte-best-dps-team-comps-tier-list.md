...
qa_score: 4.7
word_count: 1699
published_at: "2026-05-15T09:08:07.317768+00:00"
...
# Neverness to Everness Best DPS Team Comps Tier List (May 2026)
...
![Methodology](/img/nte-best-dps-team-comps-tier-list/inline-1.webp)
...
Discord reactions are currently the gold standard for boss shredding. By combining Scorch (typically applied by Incantation units like [Sakiri](/characters/sakiri-nte-free-5-star-guide) or Adler) with Nova (triggered by Psyche units like Fadia or Haniel), players create a "Discord" field. This field doesn't just deal damage; it actively weakens the "Break" bar of Elite Anomalies. Patch 1.01 recently increased Discord reaction damage by 12%, cementing its place at the top of the meta for May 2026.
...
![S Tier](/img/nte-best-dps-team-comps-tier-list/inline-2.webp)
...
**Rotation Strategy:**
1.  Start with Fadia to deploy the Psyche field and provide damage mitigation.
2.  Swap to Sakiri and use "Devour Whole" to group enemies. This also applies the Scorch status.
3.  Bring in Daffodil to trigger the Chaos/Incantation "Hexed" reaction.
4.  Switch to Baicang. His attacks will interact with the existing Scorch and Psyche stacks to trigger "Discord," shredding the enemy's defenses while he performs his main burst window.
...
**Rotation Strategy:**
1.  Use Jiuyuan to set up Anima resonance markers on the battlefield.
2.  Swap to Hotori to trigger the initial Blossom reactions, which causes Anima petals to deal secondary damage.
3.  Bring in Nanally. Her "Ichi-daime" passive allows her "Underboss" to perform follow-up attacks every time a Blossom reaction occurs.
4.  Use Zero as a battery to quickly refill Nanally’s ultimate, ensuring she stays in her enhanced state for the duration of the fight.

## A Tier

![A Tier](/img/nte-best-dps-team-comps-tier-list/inline-3.webp)
...
![B Tier](/img/nte-best-dps-team-comps-tier-list/inline-4.webp)
...
![C Tier](/img/nte-best-dps-team-comps-tier-list/inline-5.webp)
...
![Recent Changes](/img/nte-best-dps-team-comps-tier-list/inline-6.webp)
