...
qa_score: 5.5
word_count: 1781
published_at: "2026-05-19T22:22:30.359230+00:00"
...
# Best Team Comps for Neverness to Everness: Tier List (May 2026)
...
![Methodology](/img/best-team-comps-neverness-to-everness-tier-list/inline-1.webp)
...
![S Tier](/img/best-team-comps-neverness-to-everness-tier-list/inline-2.webp)
...
*   **Support/CC:** [Sakiri](/characters/sakiri-nte-free-5-star-guide) (Chaos)
*   **Survival:** Fadia (Psyche)

**Rotation Guide:**
1.  Start with **Sakiri** to pull enemies together using her "Gravity Slurry" ability.
2.  Switch to **Daffodil** to apply the Chaos status and trigger initial off-field damage.
3.  Swap to **Fadia** and use her Psyche-based burst to trigger the **Nova** Anomaly.
4.  Immediately bring in **Baicang**. Her Incantation attacks will interact with the existing Chaos/Psyche statuses to trigger **Scorch**, which then cascades into **Discord**.
...
[Nanally](/characters/nanally-guide-nte) remains the premier physical/Anima damage dealer. This team maximizes her "Underboss" follow-up attack mechanic, which triggers automatically when an ally uses a skill.

*   **Main DPS:** Nanally (Anima)
*   **Sub-DPS:** [Hotori](/characters/hotori-best-team-nte) (Anima)
...
**Rotation Guide:**
1.  Apply **Haniel’s** ATK buff.
2.  Use **Sakiri’s** skill to group enemies.
3.  Cycle **Hotori’s** rapid-fire skills to trigger Nanally's "Underboss" follow-up strikes.
4.  Stay on **Nanally** to clean up remaining targets with her wide-swinging AOE attacks.
...
![A Tier](/img/best-team-comps-neverness-to-everness-tier-list/inline-3.webp)
...
![B Tier](/img/best-team-comps-neverness-to-everness-tier-list/inline-4.webp)
...
![C Tier](/img/best-team-comps-neverness-to-everness-tier-list/inline-5.webp)
...
1.  You are not triggering an Anomaly at least once every 5 seconds.
2.  Your Main DPS is frequently interrupted or knocked back (lack of Solid Archetype or Shields).
3.  Your Ultimate abilities are rarely ready when a boss enters the Stagger state.
...
![Recent Changes](/img/best-team-comps-neverness-to-everness-tier-list/inline-6.webp)
